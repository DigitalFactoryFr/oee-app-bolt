...
-- Autorise SELECT sur sa propre ligne
...
-- Autorise UPDATE sur sa propre ligne
...
-- SELECT : autoriser l'accès si l'utilisateur a accès au projet associé au lot
...
-- INSERT : autoriser si l'utilisateur a le rôle 'operator', 'team_manager' ou 'owner'
...
-- UPDATE : autoriser si l'utilisateur a le rôle 'operator', 'team_manager' ou 'owner'
...
-- DELETE : autoriser si l'utilisateur a le rôle 'operator', 'team_manager' ou 'owner'
