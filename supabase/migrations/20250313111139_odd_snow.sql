...
BEGIN
  ...
  DROP POLICY IF EXISTS "subscriptions_view_policy" ON subscriptions;
...
BEGIN
  ...
  DROP FUNCTION IF EXISTS check_machine_limits() CASCADE;
  DROP FUNCTION IF EXISTS create_project_subscription() CASCADE;
END $$;
