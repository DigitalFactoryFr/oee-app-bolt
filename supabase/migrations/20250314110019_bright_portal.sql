...
-- Drop existing team_roles table and recreate with scope
...
-- Insert predefined roles with scopes
...
CREATE INDEX IF NOT EXISTS idx_team_members_role_email ON team_members(role, email);
